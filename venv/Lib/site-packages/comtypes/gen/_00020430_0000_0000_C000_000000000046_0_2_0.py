...
IFontDisp = Font
__all__ = [ 'FONTSTRIKETHROUGH', 'OLE_XSIZE_CONTAINER', 'Gray',
           'OLE_YSIZE_CONTAINER', 'FONTBOLD', 'FONTUNDERSCORE',
           'IFont', 'Color', 'OLE_CANCELBOOL', 'FONTNAME',
           'OLE_XSIZE_PIXELS', 'Picture', 'StdPicture', 'Monochrome',
           'OLE_YSIZE_HIMETRIC', 'IPictureDisp', 'IPicture',
           'Default', 'OLE_XSIZE_HIMETRIC', 'OLE_TRISTATE',
           'OLE_XPOS_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL', 'IFontDisp',
           'FONTSIZE', 'Font', 'FONTITALIC', 'OLE_HANDLE',
           'OLE_COLOR', 'LoadPictureConstants', 'FontEvents',
           'OLE_XPOS_PIXELS', 'OLE_YPOS_CONTAINER', 'OLE_YPOS_PIXELS',
           'OLE_OPTEXCLUSIVE', 'StdFont', 'OLE_XPOS_CONTAINER',
           'Unchecked', 'Checked', 'OLE_YSIZE_PIXELS',
